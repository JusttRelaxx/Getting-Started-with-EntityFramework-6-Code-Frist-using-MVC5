namespace ContosoUniversity.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CourseInstructor = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.CourseID, t.CourseInstructor })
                .ForeignKey("dbo.Course", t => t.CourseID, cascadeDelete: true)
                .ForeignKey("dbo.Instructor", t => t.CourseInstructor, cascadeDelete: true)
                .Index(t => t.CourseID)
                .Index(t => t.CourseInstructor);
        ...
        {
            DropForeignKey("dbo.CourseInstructor", "CourseInstructor", "dbo.Instructor");
            DropForeignKey("dbo.CourseInstructor", "CourseID", "dbo.Course");
            DropForeignKey("dbo.Course", "DepartmentID", "dbo.Department");
            DropForeignKey("dbo.Department", "InstructorID", "dbo.Instructor");
            DropForeignKey("dbo.OfficeAssignment", "InstructorID", "dbo.Instructor");
            DropIndex("dbo.CourseInstructor", new[] { "CourseInstructor" });
